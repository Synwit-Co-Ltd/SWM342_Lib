...
#define __NVIC_PRIO_BITS          3       /*!< SWM342 uses 3 Bits for the Priority Levels    */
...
typedef struct {
	...
	uint32_t RESERVED11[(0x500-0x404)/4-1];
	
	__IO uint32_t CACHECR;					//0 Cache Enable   1 Cache Bypass
	
	uint32_t RESERVED12[(0x720-0x500)/4-1];
    ...
    //Analog Control: 0x400AA000
         uint32_t RESERVED13[(0x400AA000-0x40000728)/4-1];
...
#define SYS_CLKEN0_DCMI_Pos			31
#define SYS_CLKEN0_DCMI_Msk			(0x01u<< SYS_CLKEN0_DCMI_Pos)

#define SYS_CLKEN1_GPIOE_Pos		0
#define SYS_CLKEN1_GPIOE_Msk		(0x01 << SYS_CLKEN1_GPIOE_Pos)
#define SYS_CLKEN1_GPIOF_Pos		1
#define SYS_CLKEN1_GPIOF_Msk		(0x01 << SYS_CLKEN1_GPIOF_Pos)
...
#define SYS_CLKEN1_SRA_Pos			28
#define SYS_CLKEN1_SRA_Msk			(0x01 << SYS_CLKEN1_SRA_Pos)
...
#define SPI_CTRL_BIDIOE_Pos			30		//双向模式下数据线输出使能，0：数据线处于输入接收模式   1：数据线处于输出发送模式
#define SPI_CTRL_BIDIOE_Msk			(0x01 << SPI_CTRL_BIDIOE_Pos)
#define SPI_CTRL_BIDIMODE_Pos		31		//0：标准4线SPI模式   1：三线半双工模式，master模式下通过MOSI收发数据，slave模式下通过MISO收发数据
...
#define SPI_SPIMCR_DLEN_Pos			8		//Data bytes len, 0表示1个
...
#define ADC_CR_DMAEN_Pos			4		//四位，每位对应一个序列，0 能通过CPU读取DATA_FIFO   1 只能通过DMA读取DATA_FIFO
...
#define ADC_SR_LEVEL_Pos			5		//FIFO中数据个数，对于SEQ0和SEQ1：1~15 FIFO中有1~15个数据    0 FIFO Empty时表示0个数据，FIFO Full时表示16个数据
											//				  对于SEQ1和SEQ3：1~ 8 FIFO中有1~ 8个数据    0 FIFO中有 0 个数据
...
typedef struct {
	...
	__IO uint32_t DSTIE;					//Destination Interrupt Enable
	
	__IO uint32_t DSTIM;
	
	__IO uint32_t DSTIF;
	
	__IO uint32_t SRCIE;					//Source Interrupt Enable
	...
	struct {
		...
		__IO uint32_t PARTLEN;				//Part Length，当 DMA 搬运 PARTLEN 个数据后，可产生 PART 中断
...
#define DMA_DSTIE_CH0SGHALF_Pos		0 		//Scatter-Gather Transfer Half Interrupt Enable
#define DMA_DSTIE_CH0SGHALF_Msk		(0x01 << DMA_DSTIE_CH0SGHALF_Pos)
#define DMA_DSTIE_CH0SGDONE_Pos		1 		//Scatter-Gather Transfer Done Interrupt Enable
#define DMA_DSTIE_CH0SGDONE_Msk		(0x01 << DMA_DSTIE_CH0SGDONE_Pos)
#define DMA_DSTIE_CH0PART_Pos 		2 		//当 DMA 搬运 PARTLEN 个数据后，可产生 PART 中断
#define DMA_DSTIE_CH0PART_Msk 		(0x01 << DMA_DSTIE_CH0PART_Pos)
#define DMA_DSTIE_CH1SGHALF_Pos		3
#define DMA_DSTIE_CH1SGHALF_Msk		(0x01 << DMA_DSTIE_CH1SGHALF_Pos)
#define DMA_DSTIE_CH1SGDONE_Pos		4
#define DMA_DSTIE_CH1SGDONE_Msk		(0x01 << DMA_DSTIE_CH1SGDONE_Pos)
#define DMA_DSTIE_CH1PART_Pos 		5
#define DMA_DSTIE_CH1PART_Msk 		(0x01 << DMA_DSTIE_CH1PART_Pos)
#define DMA_DSTIE_CH2SGHALF_Pos		6
#define DMA_DSTIE_CH2SGHALF_Msk		(0x01 << DMA_DSTIE_CH2SGHALF_Pos)
#define DMA_DSTIE_CH2SGDONE_Pos		7
#define DMA_DSTIE_CH2SGDONE_Msk		(0x01 << DMA_DSTIE_CH2SGDONE_Pos)
#define DMA_DSTIE_CH2PART_Pos 		8
#define DMA_DSTIE_CH2PART_Msk 		(0x01 << DMA_DSTIE_CH2PART_Pos)
#define DMA_DSTIE_CH3SGHALF_Pos		9
#define DMA_DSTIE_CH3SGHALF_Msk		(0x01 << DMA_DSTIE_CH3SGHALF_Pos)
#define DMA_DSTIE_CH3SGDONE_Pos		10
#define DMA_DSTIE_CH3SGDONE_Msk		(0x01 << DMA_DSTIE_CH3SGDONE_Pos)
#define DMA_DSTIE_CH3PART_Pos 		11
#define DMA_DSTIE_CH3PART_Msk 		(0x01 << DMA_DSTIE_CH3PART_Pos)
#define DMA_DSTIE_CH4SGHALF_Pos		12
#define DMA_DSTIE_CH4SGHALF_Msk		(0x01 << DMA_DSTIE_CH4SGHALF_Pos)
#define DMA_DSTIE_CH4SGDONE_Pos		13
#define DMA_DSTIE_CH4SGDONE_Msk		(0x01 << DMA_DSTIE_CH4SGDONE_Pos)
#define DMA_DSTIE_CH4PART_Pos 		14
#define DMA_DSTIE_CH4PART_Msk 		(0x01 << DMA_DSTIE_CH4PART_Pos)
#define DMA_DSTIE_CH5SGHALF_Pos		15
#define DMA_DSTIE_CH5SGHALF_Msk		(0x01 << DMA_DSTIE_CH5SGHALF_Pos)
#define DMA_DSTIE_CH5SGDONE_Pos		16
#define DMA_DSTIE_CH5SGDONE_Msk		(0x01 << DMA_DSTIE_CH5SGDONE_Pos)
#define DMA_DSTIE_CH5PART_Pos 		17
#define DMA_DSTIE_CH5PART_Msk 		(0x01 << DMA_DSTIE_CH5PART_Pos)

#define DMA_DSTIM_CH0SGHALF_Pos		0 
#define DMA_DSTIM_CH0SGHALF_Msk		(0x01 << DMA_DSTIM_CH0SGHALF_Pos)
#define DMA_DSTIM_CH0SGDONE_Pos		1
#define DMA_DSTIM_CH0SGDONE_Msk		(0x01 << DMA_DSTIM_CH0SGDONE_Pos)
#define DMA_DSTIM_CH0PART_Pos 		2
#define DMA_DSTIM_CH0PART_Msk 		(0x01 << DMA_DSTIM_CH0PART_Pos)
#define DMA_DSTIM_CH1SGHALF_Pos		3
#define DMA_DSTIM_CH1SGHALF_Msk		(0x01 << DMA_DSTIM_CH1SGHALF_Pos)
#define DMA_DSTIM_CH1SGDONE_Pos		4
#define DMA_DSTIM_CH1SGDONE_Msk		(0x01 << DMA_DSTIM_CH1SGDONE_Pos)
#define DMA_DSTIM_CH1PART_Pos 		5
#define DMA_DSTIM_CH1PART_Msk 		(0x01 << DMA_DSTIM_CH1PART_Pos)
#define DMA_DSTIM_CH2SGHALF_Pos		6
#define DMA_DSTIM_CH2SGHALF_Msk		(0x01 << DMA_DSTIM_CH2SGHALF_Pos)
#define DMA_DSTIM_CH2SGDONE_Pos		7
#define DMA_DSTIM_CH2SGDONE_Msk		(0x01 << DMA_DSTIM_CH2SGDONE_Pos)
#define DMA_DSTIM_CH2PART_Pos 		8
#define DMA_DSTIM_CH2PART_Msk 		(0x01 << DMA_DSTIM_CH2PART_Pos)
#define DMA_DSTIM_CH3SGHALF_Pos		9
#define DMA_DSTIM_CH3SGHALF_Msk		(0x01 << DMA_DSTIM_CH3SGHALF_Pos)
#define DMA_DSTIM_CH3SGDONE_Pos		10
#define DMA_DSTIM_CH3SGDONE_Msk		(0x01 << DMA_DSTIM_CH3SGDONE_Pos)
#define DMA_DSTIM_CH3PART_Pos 		11
#define DMA_DSTIM_CH3PART_Msk 		(0x01 << DMA_DSTIM_CH3PART_Pos)
#define DMA_DSTIM_CH4SGHALF_Pos		12
#define DMA_DSTIM_CH4SGHALF_Msk		(0x01 << DMA_DSTIM_CH4SGHALF_Pos)
#define DMA_DSTIM_CH4SGDONE_Pos		13
#define DMA_DSTIM_CH4SGDONE_Msk		(0x01 << DMA_DSTIM_CH4SGDONE_Pos)
#define DMA_DSTIM_CH4PART_Pos 		14
#define DMA_DSTIM_CH4PART_Msk 		(0x01 << DMA_DSTIM_CH4PART_Pos)
#define DMA_DSTIM_CH5SGHALF_Pos		15
#define DMA_DSTIM_CH5SGHALF_Msk		(0x01 << DMA_DSTIM_CH5SGHALF_Pos)
#define DMA_DSTIM_CH5SGDONE_Pos		16
#define DMA_DSTIM_CH5SGDONE_Msk		(0x01 << DMA_DSTIM_CH5SGDONE_Pos)
#define DMA_DSTIM_CH5PART_Pos 		17
#define DMA_DSTIM_CH5PART_Msk 		(0x01 << DMA_DSTIM_CH5PART_Pos)

#define DMA_DSTIF_CH0SGHALF_Pos		0 
#define DMA_DSTIF_CH0SGHALF_Msk		(0x01 << DMA_DSTIF_CH0SGHALF_Pos)
#define DMA_DSTIF_CH0SGDONE_Pos		1
#define DMA_DSTIF_CH0SGDONE_Msk		(0x01 << DMA_DSTIF_CH0SGDONE_Pos)
#define DMA_DSTIF_CH0PART_Pos 		2
#define DMA_DSTIF_CH0PART_Msk 		(0x01 << DMA_DSTIF_CH0PART_Pos)
#define DMA_DSTIF_CH1SGHALF_Pos		3
#define DMA_DSTIF_CH1SGHALF_Msk		(0x01 << DMA_DSTIF_CH1SGHALF_Pos)
#define DMA_DSTIF_CH1SGDONE_Pos		4
#define DMA_DSTIF_CH1SGDONE_Msk		(0x01 << DMA_DSTIF_CH1SGDONE_Pos)
#define DMA_DSTIF_CH1PART_Pos 		5
#define DMA_DSTIF_CH1PART_Msk 		(0x01 << DMA_DSTIF_CH1PART_Pos)
#define DMA_DSTIF_CH2SGHALF_Pos		6
#define DMA_DSTIF_CH2SGHALF_Msk		(0x01 << DMA_DSTIF_CH2SGHALF_Pos)
#define DMA_DSTIF_CH2SGDONE_Pos		7
#define DMA_DSTIF_CH2SGDONE_Msk		(0x01 << DMA_DSTIF_CH2SGDONE_Pos)
#define DMA_DSTIF_CH2PART_Pos 		8
#define DMA_DSTIF_CH2PART_Msk 		(0x01 << DMA_DSTIF_CH2PART_Pos)
#define DMA_DSTIF_CH3SGHALF_Pos		9
#define DMA_DSTIF_CH3SGHALF_Msk		(0x01 << DMA_DSTIF_CH3SGHALF_Pos)
#define DMA_DSTIF_CH3SGDONE_Pos		10
#define DMA_DSTIF_CH3SGDONE_Msk		(0x01 << DMA_DSTIF_CH3SGDONE_Pos)
#define DMA_DSTIF_CH3PART_Pos 		11
#define DMA_DSTIF_CH3PART_Msk 		(0x01 << DMA_DSTIF_CH3PART_Pos)
#define DMA_DSTIF_CH4SGHALF_Pos		12
#define DMA_DSTIF_CH4SGHALF_Msk		(0x01 << DMA_DSTIF_CH4SGHALF_Pos)
#define DMA_DSTIF_CH4SGDONE_Pos		13
#define DMA_DSTIF_CH4SGDONE_Msk		(0x01 << DMA_DSTIF_CH4SGDONE_Pos)
#define DMA_DSTIF_CH4PART_Pos 		14
#define DMA_DSTIF_CH4PART_Msk 		(0x01 << DMA_DSTIF_CH4PART_Pos)
#define DMA_DSTIF_CH5SGHALF_Pos		15
#define DMA_DSTIF_CH5SGHALF_Msk		(0x01 << DMA_DSTIF_CH5SGHALF_Pos)
#define DMA_DSTIF_CH5SGDONE_Pos		16
#define DMA_DSTIF_CH5SGDONE_Msk		(0x01 << DMA_DSTIF_CH5SGDONE_Pos)
#define DMA_DSTIF_CH5PART_Pos 		17
#define DMA_DSTIF_CH5PART_Msk 		(0x01 << DMA_DSTIF_CH5PART_Pos)

#define DMA_SRCIE_CH0SGHALF_Pos		0 		//Scatter-Gather Transfer Half Interrupt Enable
#define DMA_SRCIE_CH0SGHALF_Msk		(0x01 << DMA_SRCIE_CH0SGHALF_Pos)
#define DMA_SRCIE_CH0SGDONE_Pos		1 		//Scatter-Gather Transfer Done Interrupt Enable
#define DMA_SRCIE_CH0SGDONE_Msk		(0x01 << DMA_SRCIE_CH0SGDONE_Pos)
#define DMA_SRCIE_CH0PART_Pos 		2 		//当 DMA 搬运 PARTLEN 个数据后，可产生 PART 中断
#define DMA_SRCIE_CH0PART_Msk 		(0x01 << DMA_SRCIE_CH0PART_Pos)
#define DMA_SRCIE_CH1SGHALF_Pos		3
#define DMA_SRCIE_CH1SGHALF_Msk		(0x01 << DMA_SRCIE_CH1SGHALF_Pos)
#define DMA_SRCIE_CH1SGDONE_Pos		4
#define DMA_SRCIE_CH1SGDONE_Msk		(0x01 << DMA_SRCIE_CH1SGDONE_Pos)
#define DMA_SRCIE_CH1PART_Pos 		5
#define DMA_SRCIE_CH1PART_Msk 		(0x01 << DMA_SRCIE_CH1PART_Pos)
#define DMA_SRCIE_CH2SGHALF_Pos		6
#define DMA_SRCIE_CH2SGHALF_Msk		(0x01 << DMA_SRCIE_CH2SGHALF_Pos)
#define DMA_SRCIE_CH2SGDONE_Pos		7
#define DMA_SRCIE_CH2SGDONE_Msk		(0x01 << DMA_SRCIE_CH2SGDONE_Pos)
#define DMA_SRCIE_CH2PART_Pos 		8
#define DMA_SRCIE_CH2PART_Msk 		(0x01 << DMA_SRCIE_CH2PART_Pos)
#define DMA_SRCIE_CH3SGHALF_Pos		9
#define DMA_SRCIE_CH3SGHALF_Msk		(0x01 << DMA_SRCIE_CH3SGHALF_Pos)
#define DMA_SRCIE_CH3SGDONE_Pos		10
#define DMA_SRCIE_CH3SGDONE_Msk		(0x01 << DMA_SRCIE_CH3SGDONE_Pos)
#define DMA_SRCIE_CH3PART_Pos 		11
#define DMA_SRCIE_CH3PART_Msk 		(0x01 << DMA_SRCIE_CH3PART_Pos)
#define DMA_SRCIE_CH4SGHALF_Pos		12
#define DMA_SRCIE_CH4SGHALF_Msk		(0x01 << DMA_SRCIE_CH4SGHALF_Pos)
#define DMA_SRCIE_CH4SGDONE_Pos		13
#define DMA_SRCIE_CH4SGDONE_Msk		(0x01 << DMA_SRCIE_CH4SGDONE_Pos)
#define DMA_SRCIE_CH4PART_Pos 		14
#define DMA_SRCIE_CH4PART_Msk 		(0x01 << DMA_SRCIE_CH4PART_Pos)
#define DMA_SRCIE_CH5SGHALF_Pos		15
#define DMA_SRCIE_CH5SGHALF_Msk		(0x01 << DMA_SRCIE_CH5SGHALF_Pos)
#define DMA_SRCIE_CH5SGDONE_Pos		16
#define DMA_SRCIE_CH5SGDONE_Msk		(0x01 << DMA_SRCIE_CH5SGDONE_Pos)
#define DMA_SRCIE_CH5PART_Pos 		17
#define DMA_SRCIE_CH5PART_Msk 		(0x01 << DMA_SRCIE_CH5PART_Pos)

#define DMA_SRCIM_CH0SGHALF_Pos		0 
#define DMA_SRCIM_CH0SGHALF_Msk		(0x01 << DMA_SRCIM_CH0SGHALF_Pos)
#define DMA_SRCIM_CH0SGDONE_Pos		1
#define DMA_SRCIM_CH0SGDONE_Msk		(0x01 << DMA_SRCIM_CH0SGDONE_Pos)
#define DMA_SRCIM_CH0PART_Pos 		2
#define DMA_SRCIM_CH0PART_Msk 		(0x01 << DMA_SRCIM_CH0PART_Pos)
#define DMA_SRCIM_CH1SGHALF_Pos		3
#define DMA_SRCIM_CH1SGHALF_Msk		(0x01 << DMA_SRCIM_CH1SGHALF_Pos)
#define DMA_SRCIM_CH1SGDONE_Pos		4
#define DMA_SRCIM_CH1SGDONE_Msk		(0x01 << DMA_SRCIM_CH1SGDONE_Pos)
#define DMA_SRCIM_CH1PART_Pos 		5
#define DMA_SRCIM_CH1PART_Msk 		(0x01 << DMA_SRCIM_CH1PART_Pos)
#define DMA_SRCIM_CH2SGHALF_Pos		6
#define DMA_SRCIM_CH2SGHALF_Msk		(0x01 << DMA_SRCIM_CH2SGHALF_Pos)
#define DMA_SRCIM_CH2SGDONE_Pos		7
#define DMA_SRCIM_CH2SGDONE_Msk		(0x01 << DMA_SRCIM_CH2SGDONE_Pos)
#define DMA_SRCIM_CH2PART_Pos 		8
#define DMA_SRCIM_CH2PART_Msk 		(0x01 << DMA_SRCIM_CH2PART_Pos)
#define DMA_SRCIM_CH3SGHALF_Pos		9
#define DMA_SRCIM_CH3SGHALF_Msk		(0x01 << DMA_SRCIM_CH3SGHALF_Pos)
#define DMA_SRCIM_CH3SGDONE_Pos		10
#define DMA_SRCIM_CH3SGDONE_Msk		(0x01 << DMA_SRCIM_CH3SGDONE_Pos)
#define DMA_SRCIM_CH3PART_Pos 		11
#define DMA_SRCIM_CH3PART_Msk 		(0x01 << DMA_SRCIM_CH3PART_Pos)
#define DMA_SRCIM_CH4SGHALF_Pos		12
#define DMA_SRCIM_CH4SGHALF_Msk		(0x01 << DMA_SRCIM_CH4SGHALF_Pos)
#define DMA_SRCIM_CH4SGDONE_Pos		13
#define DMA_SRCIM_CH4SGDONE_Msk		(0x01 << DMA_SRCIM_CH4SGDONE_Pos)
#define DMA_SRCIM_CH4PART_Pos 		14
#define DMA_SRCIM_CH4PART_Msk 		(0x01 << DMA_SRCIM_CH4PART_Pos)
#define DMA_SRCIM_CH5SGHALF_Pos		15
#define DMA_SRCIM_CH5SGHALF_Msk		(0x01 << DMA_SRCIM_CH5SGHALF_Pos)
#define DMA_SRCIM_CH5SGDONE_Pos		16
#define DMA_SRCIM_CH5SGDONE_Msk		(0x01 << DMA_SRCIM_CH5SGDONE_Pos)
#define DMA_SRCIM_CH5PART_Pos 		17
#define DMA_SRCIM_CH5PART_Msk 		(0x01 << DMA_SRCIM_CH5PART_Pos)

#define DMA_SRCIF_CH0SGHALF_Pos		0 
#define DMA_SRCIF_CH0SGHALF_Msk		(0x01 << DMA_SRCIF_CH0SGHALF_Pos)
#define DMA_SRCIF_CH0SGDONE_Pos		1
#define DMA_SRCIF_CH0SGDONE_Msk		(0x01 << DMA_SRCIF_CH0SGDONE_Pos)
#define DMA_SRCIF_CH0PART_Pos 		2
#define DMA_SRCIF_CH0PART_Msk 		(0x01 << DMA_SRCIF_CH0PART_Pos)
#define DMA_SRCIF_CH1SGHALF_Pos		3
#define DMA_SRCIF_CH1SGHALF_Msk		(0x01 << DMA_SRCIF_CH1SGHALF_Pos)
#define DMA_SRCIF_CH1SGDONE_Pos		4
#define DMA_SRCIF_CH1SGDONE_Msk		(0x01 << DMA_SRCIF_CH1SGDONE_Pos)
#define DMA_SRCIF_CH1PART_Pos 		5
#define DMA_SRCIF_CH1PART_Msk 		(0x01 << DMA_SRCIF_CH1PART_Pos)
#define DMA_SRCIF_CH2SGHALF_Pos		6
#define DMA_SRCIF_CH2SGHALF_Msk		(0x01 << DMA_SRCIF_CH2SGHALF_Pos)
#define DMA_SRCIF_CH2SGDONE_Pos		7
#define DMA_SRCIF_CH2SGDONE_Msk		(0x01 << DMA_SRCIF_CH2SGDONE_Pos)
#define DMA_SRCIF_CH2PART_Pos 		8
#define DMA_SRCIF_CH2PART_Msk 		(0x01 << DMA_SRCIF_CH2PART_Pos)
#define DMA_SRCIF_CH3SGHALF_Pos		9
#define DMA_SRCIF_CH3SGHALF_Msk		(0x01 << DMA_SRCIF_CH3SGHALF_Pos)
#define DMA_SRCIF_CH3SGDONE_Pos		10
#define DMA_SRCIF_CH3SGDONE_Msk		(0x01 << DMA_SRCIF_CH3SGDONE_Pos)
#define DMA_SRCIF_CH3PART_Pos 		11
#define DMA_SRCIF_CH3PART_Msk 		(0x01 << DMA_SRCIF_CH3PART_Pos)
#define DMA_SRCIF_CH4SGHALF_Pos		12
#define DMA_SRCIF_CH4SGHALF_Msk		(0x01 << DMA_SRCIF_CH4SGHALF_Pos)
#define DMA_SRCIF_CH4SGDONE_Pos		13
#define DMA_SRCIF_CH4SGDONE_Msk		(0x01 << DMA_SRCIF_CH4SGDONE_Pos)
#define DMA_SRCIF_CH4PART_Pos 		14
#define DMA_SRCIF_CH4PART_Msk 		(0x01 << DMA_SRCIF_CH4PART_Pos)
#define DMA_SRCIF_CH5SGHALF_Pos		15
#define DMA_SRCIF_CH5SGHALF_Msk		(0x01 << DMA_SRCIF_CH5SGHALF_Pos)
#define DMA_SRCIF_CH5SGDONE_Pos		16
#define DMA_SRCIF_CH5SGDONE_Msk		(0x01 << DMA_SRCIF_CH5SGDONE_Pos)
#define DMA_SRCIF_CH5PART_Pos 		17
#define DMA_SRCIF_CH5PART_Msk 		(0x01 << DMA_SRCIF_CH5PART_Pos)
...
#define DMA_CR_ABORT_Pos			28		//提前终止传输，将DMA内部Buffer中的数据冲刷出来
#define DMA_CR_ABORT_Msk			(0x01 << DMA_CR_ABORT_Pos)
...
typedef struct {
	...
	__IO uint32_t AFID[6];					//Acceptance Filter ID
	
	__IO uint32_t AFDB;						//Acceptance Filter Data Byte
	
	__IO uint32_t AFCR;						//Acceptance Filter Control Register
	
	__IO uint32_t AFMID[2];					//Acceptance Filter ID Mask
	
	__IO uint32_t AFMDB;					//Acceptance Filter Data Byte Mask
	
	__IO uint32_t AFMCR;					//Acceptance Filter Mask Control Register
	...
	__IO uint32_t NBT0;						//Nominal Bit Timing
	__IO uint32_t NBT1;
	
	__IO uint32_t DBT;						//Data Bit Timing
	
	__IO uint32_t ERRCNT;
	
	__IO uint32_t ERRSR;
	
	__IO uint32_t RXTS;						//RX Timestamp
	
	__IO uint32_t IF;
	
	__IO uint32_t TXBUF[3][16];
	
	__IO uint32_t RXBUF[2][16];
} CANFD_TypeDef;


#define CANFD_CR_RFF1CLR_Pos		1		//RX FIFO 1 Clear (3 frame depth)
#define CANFD_CR_RFF1CLR_Msk		(0x01 << CANFD_CR_RFF1CLR_Pos)
#define CANFD_CR_RFF0CLR_Pos		2
#define CANFD_CR_RFF0CLR_Msk		(0x01 << CANFD_CR_RFF0CLR_Pos)
#define CANFD_CR_TBF2REQ_Pos		3		//TX Buffer 2 Send Request
#define CANFD_CR_TBF2REQ_Msk		(0x01 << CANFD_CR_TBF2REQ_Pos)
#define CANFD_CR_TBF1REQ_Pos		4
#define CANFD_CR_TBF1REQ_Msk		(0x01 << CANFD_CR_TBF1REQ_Pos)
#define CANFD_CR_TBF0REQ_Pos		5
#define CANFD_CR_TBF0REQ_Msk		(0x01 << CANFD_CR_TBF0REQ_Pos)
#define CANFD_CR_RFF1POP_Pos		6		//Pop 1 frame from RX FIFO 1
#define CANFD_CR_RFF1POP_Msk		(0x01 << CANFD_CR_RFF1POP_Pos)
#define CANFD_CR_RFF0POP_Pos		7
#define CANFD_CR_RFF0POP_Msk		(0x01 << CANFD_CR_RFF0POP_Pos)
#define CANFD_CR_IERXOK_Pos			11
#define CANFD_CR_IERXOK_Msk			(0x01 << CANFD_CR_IERXOK_Pos)
#define CANFD_CR_IETXOK_Pos			12
#define CANFD_CR_IETXOK_Msk			(0x01 << CANFD_CR_IETXOK_Pos)
#define CANFD_CR_IEERR_Pos			13
#define CANFD_CR_IEERR_Msk			(0x01 << CANFD_CR_IEERR_Pos)
#define CANFD_CR_IERXOV_Pos			14
#define CANFD_CR_IERXOV_Msk			(0x01 << CANFD_CR_IERXOV_Pos)
#define CANFD_CR_IEWKUP_Pos			15
#define CANFD_CR_IEWKUP_Msk			(0x01 << CANFD_CR_IEWKUP_Pos)
#define CANFD_CR_DBEN_Pos			22		//RX Debounce Enable
#define CANFD_CR_DBEN_Msk			(0x01 << CANFD_CR_DBEN_Pos)
#define CANFD_CR_TSEN_Pos			23		//Timestamp Enable
#define CANFD_CR_TSEN_Msk			(0x01 << CANFD_CR_TSEN_Pos)
#define CANFD_CR_MODE_Pos			24		//0 Config   1 Normal   2 Sleep   3 Listen   4 Loopback
#define CANFD_CR_MODE_Msk			(0x07 << CANFD_CR_MODE_Pos)
#define CANFD_CR_RETX_Pos			27		//retransmission times, 0 always   1 not   2 3-times at most   3 8-times at most
#define CANFD_CR_RETX_Msk			(0x03 << CANFD_CR_RETX_Pos)
#define CANFD_CR_TXOV_Pos			29		//TX 1 OVERLOAD frame for RX FIFO full condition
#define CANFD_CR_TXOV_Msk			(0x01 << CANFD_CR_TXOV_Pos)
#define CANFD_CR_RESET_Pos			30		//Reset request, auto clear after done
#define CANFD_CR_RESET_Msk			(0x01 << CANFD_CR_RESET_Pos)

#define CANFD_SR_RXOV_Pos			2		//0 no buffer overflow   1 RX buffer0 overflow   2 RX buffer1 overflow   3 both overflow
#define CANFD_SR_RXOV_Msk			(0x03 << CANFD_SR_RXOV_Pos)
#define CANFD_SR_RXBUSY_Pos			4		//1 a message is receiving
#define CANFD_SR_RXBUSY_Msk			(0x01 << CANFD_SR_RXBUSY_Pos)
#define CANFD_SR_TXBUSY_Pos			5		//1 a message is transmitting
#define CANFD_SR_TXBUSY_Msk			(0x01 << CANFD_SR_TXBUSY_Pos)
#define CANFD_SR_ERRWARN_Pos		6		//RXERR或TXERR之一达到96
#define CANFD_SR_ERRWARN_Msk		(0x01 << CANFD_SR_ERRWARN_Pos)
#define CANFD_SR_BUSOFF_Pos			7		//TXERR达到256置位，然后CAN控制器等待128个连续11位隐性位以离开Busoff状态
#define CANFD_SR_BUSOFF_Msk			(0x01 << CANFD_SR_BUSOFF_Pos)
#define CANFD_SR_RFF1LVL_Pos		9		//RX FIFO 1 level, 0 empty   1 one message   2 two message   3 full
#define CANFD_SR_RFF1LVL_Msk		(0x03 << CANFD_SR_RFF1LVL_Pos)
#define CANFD_SR_RFF0LVL_Pos		11
#define CANFD_SR_RFF0LVL_Msk		(0x03 << CANFD_SR_RFF0LVL_Pos)
#define CANFD_SR_TBFTXING_Pos		16		//0 No buffer is transmitting   1 Buffer0 is transmitting   2 Buffer1 is transmitting   3 Buffer2 is transmitting
#define CANFD_SR_TBFTXING_Msk		(0x03 << CANFD_SR_TBFTXING_Pos)
#define CANFD_SR_TBF2ARBLOST_Pos	18 		//TX Buffer 2 transmit arbitration lost
#define CANFD_SR_TBF2ARBLOST_Msk	(0x01 << CANFD_SR_TBF2ARBLOST_Pos)
#define CANFD_SR_TBF1ARBLOST_Pos	19
#define CANFD_SR_TBF1ARBLOST_Msk	(0x01 << CANFD_SR_TBF1ARBLOST_Pos)
#define CANFD_SR_TBF0ARBLOST_Pos	20
#define CANFD_SR_TBF0ARBLOST_Msk	(0x01 << CANFD_SR_TBF0ARBLOST_Pos)
#define CANFD_SR_TBF2ARORT_Pos		21		//TX Buffer 2 transmit abort
#define CANFD_SR_TBF2ARORT_Msk		(0x01 << CANFD_SR_TBF2ARORT_Pos)
#define CANFD_SR_TBF1ARORT_Pos		22
#define CANFD_SR_TBF1ARORT_Msk		(0x01 << CANFD_SR_TBF1ARORT_Pos)
#define CANFD_SR_TBF0ARORT_Pos		23
#define CANFD_SR_TBF0ARORT_Msk		(0x01 << CANFD_SR_TBF0ARORT_Pos)

#define CANFD_CR0_RESI_Pos			5		//received ESI bit, 0 frame is from error active node   1 frame is from error passive node
#define CANFD_CR0_RESI_Msk			(0x01 << CANFD_CR0_RESI_Pos)
#define CANFD_CR0_BRSW_Pos			6		//Bit rate switch
#define CANFD_CR0_BRSW_Msk			(0x01 << CANFD_CR0_BRSW_Pos)
#define CANFD_CR0_FDEN_Pos			7		//1 FD frame   0 Non-FD frame
#define CANFD_CR0_FDEN_Msk			(0x01 << CANFD_CR0_FDEN_Pos)
#define CANFD_CR0_IDE_Pos			14		//0 standard frame   1 extended format
#define CANFD_CR0_IDE_Msk			(0x01 << CANFD_CR0_IDE_Pos)
#define CANFD_CR0_RTR_Pos			15
#define CANFD_CR0_RTR_Msk			(0x01 << CANFD_CR0_RTR_Pos)
#define CANFD_CR0_EID0T9_Pos		22		//Extended ID bit 0 to 9
#define CANFD_CR0_EID0T9_Msk		(0x3FFu<< CANFD_CR0_EID0T9_Pos)

#define CANFD_CR1_EID10T17_Pos		0 		//Extended ID bit 10 to 17
#define CANFD_CR1_EID10T17_Msk		(0xFF << CANFD_CR1_EID10T17_Pos)
#define CANFD_CR1_DLC_Pos			8 		//Data Length Code
#define CANFD_CR1_DLC_Msk			(0x0F << CANFD_CR1_DLC_Pos)
#define CANFD_CR1_BID_Pos			13		//Standard Format ID and Extended Format Base ID
#define CANFD_CR1_BID_Msk			(0x7FF<< CANFD_CR1_BID_Pos)

#define CANFD_AFID_EID_Pos			3		//Extended ID
#define CANFD_AFID_EID_Msk			(0x3FFFF<< CANFD_AFID_EID_Pos)
#define CANFD_AFID_BID_Pos			21		//Standard Format ID and Extended Format Base ID
#define CANFD_AFID_BID_Msk			(0x7FFu<< CANFD_AFID_BID_Pos)

#define CANFD_AFDB_RX0B0_Pos		0
#define CANFD_AFDB_RX0B0_Msk		(0xFF << CANFD_AFDB_RX0B0_Pos)
#define CANFD_AFDB_RX0B1_Pos		8
#define CANFD_AFDB_RX0B1_Msk		(0xFF << CANFD_AFDB_RX0B1_Pos)
#define CANFD_AFDB_RX1B0_Pos		16
#define CANFD_AFDB_RX1B0_Msk		(0xFF << CANFD_AFDB_RX1B0_Pos)
#define CANFD_AFDB_RX1B1_Pos		24
#define CANFD_AFDB_RX1B1_Msk		(0xFF << CANFD_AFDB_RX1B1_Pos)

#define CANFD_AFCR_RBF1DB1_Pos		2		//RX Buffer 1 data byte 1 filter enable
#define CANFD_AFCR_RBF1DB1_Msk		(0x01 << CANFD_AFCR_RBF1DB1_Pos)
#define CANFD_AFCR_RBF1DB0_Pos		3		//RX Buffer 1 data byte 0 filter enable
#define CANFD_AFCR_RBF1DB0_Msk		(0x01 << CANFD_AFCR_RBF1DB0_Pos)
#define CANFD_AFCR_RBF0DB1_Pos		4		//RX Buffer 0 data byte 1 filter enable
#define CANFD_AFCR_RBF0DB1_Msk		(0x01 << CANFD_AFCR_RBF0DB1_Pos)
#define CANFD_AFCR_RBF0DB0_Pos		5		//RX Buffer 0 data byte 0 filter enable
#define CANFD_AFCR_RBF0DB0_Msk		(0x01 << CANFD_AFCR_RBF0DB0_Pos)
#define CANFD_AFCR_RBF1ID_Pos		6		//RX Buffer 1 ID filter enable
#define CANFD_AFCR_RBF1ID_Msk		(0x01 << CANFD_AFCR_RBF1ID_Pos)
#define CANFD_AFCR_RBF0ID_Pos		7		//RX Buffer 0 ID filter enable, By only setting this bit, receive buffer0 is allowed to receive message
#define CANFD_AFCR_RBF0ID_Msk		(0x01 << CANFD_AFCR_RBF0ID_Pos)
#define CANFD_AFCR_FD_Pos			10		//0 both non-FD and FD frame can be accepted   1 only non-FD frame   2 only FD frame
#define CANFD_AFCR_FD_Msk			(0x03 << CANFD_AFCR_FD_Pos)
#define CANFD_AFCR_RTR_Pos			12		//0 both data and remote frame can be accepted   1 only data frame   2 only remote frame
#define CANFD_AFCR_RTR_Msk			(0x03 << CANFD_AFCR_RTR_Pos)
#define CANFD_AFCR_IDE_Pos			14		//0 both standard and extended frame can be accepted   1 only standard frame   2 only extended frame
#define CANFD_AFCR_IDE_Msk			(0x03 << CANFD_AFCR_IDE_Pos)

#define CANFD_AFMID_EID_Pos			3		//Extended ID
#define CANFD_AFMID_EID_Msk			(0x3FFFF<< CANFD_AFMID_EID_Pos)
#define CANFD_AFMID_BID_Pos			21		//Standard Format ID and Extended Format Base ID
#define CANFD_AFMID_BID_Msk			(0x7FFu<< CANFD_AFMID_BID_Pos)

#define CANFD_AFMDB_RX0B0_Pos		0
#define CANFD_AFMDB_RX0B0_Msk		(0xFF << CANFD_AFMDB_RX0B0_Pos)
#define CANFD_AFMDB_RX0B1_Pos		8
#define CANFD_AFMDB_RX0B1_Msk		(0xFF << CANFD_AFMDB_RX0B1_Pos)
#define CANFD_AFMDB_RX1B0_Pos		16
#define CANFD_AFMDB_RX1B0_Msk		(0xFF << CANFD_AFMDB_RX1B0_Pos)
#define CANFD_AFMDB_RX1B1_Pos		24
#define CANFD_AFMDB_RX1B1_Msk		(0xFF << CANFD_AFMDB_RX1B1_Pos)

#define CANFD_AFMCR_RBF1DB1_Pos		1		//RX Buffer 1 data byte 1 filter mask enable
#define CANFD_AFMCR_RBF1DB1_Msk		(0x01 << CANFD_AFMCR_RBF1DB1_Pos)
#define CANFD_AFMCR_RBF1DB0_Pos		2		//RX Buffer 1 data byte 0 filter mask enable
#define CANFD_AFMCR_RBF1DB0_Msk		(0x01 << CANFD_AFMCR_RBF1DB0_Pos)
#define CANFD_AFMCR_RBF0DB1_Pos		3		//RX Buffer 0 data byte 1 filter mask enable
#define CANFD_AFMCR_RBF0DB1_Msk		(0x01 << CANFD_AFMCR_RBF0DB1_Pos)
#define CANFD_AFMCR_RBF0DB0_Pos		4		//RX Buffer 0 data byte 0 filter mask enable
#define CANFD_AFMCR_RBF0DB0_Msk		(0x01 << CANFD_AFMCR_RBF0DB0_Pos)
#define CANFD_AFMCR_RBF1ID_Pos		5		//RX Buffer 1 ID filter mask enable
#define CANFD_AFMCR_RBF1ID_Msk		(0x01 << CANFD_AFMCR_RBF1ID_Pos)
#define CANFD_AFMCR_RBF0ID_Pos		6		//RX Buffer 0 ID filter mask enable
#define CANFD_AFMCR_RBF0ID_Msk		(0x01 << CANFD_AFMCR_RBF0ID_Pos)
#define CANFD_AFMCR_ALL_Pos			7
#define CANFD_AFMCR_ALL_Msk			(0x01 << CANFD_AFMCR_ALL_Pos)

#define CANFD_NBT0_SJW_Pos			3
#define CANFD_NBT0_SJW_Msk			(0x1F << CANFD_NBT0_SJW_Pos)
#define CANFD_NBT0_BRP_Pos			8
#define CANFD_NBT0_BRP_Msk			(0xFF << CANFD_NBT0_BRP_Pos)
#define CANFD_NBT0_PROP_Pos			17
#define CANFD_NBT0_PROP_Msk			(0x3F << CANFD_NBT0_PROP_Pos)
#define CANFD_NBT0_SEG1_Pos			27
#define CANFD_NBT0_SEG1_Msk			(0x1Fu<< CANFD_NBT0_SEG1_Pos)

#define CANFD_NBT1_SEG2_Pos			3
#define CANFD_NBT1_SEG2_Msk			(0x1F << CANFD_NBT1_SEG2_Pos)

#define CANFD_DBT_BRP_Pos			0
#define CANFD_DBT_BRP_Msk			(0xFF << CANFD_DBT_BRP_Pos)
#define CANFD_DBT_SJW_Pos			9
#define CANFD_DBT_SJW_Msk			(0x03 << CANFD_DBT_SJW_Pos)
#define CANFD_DBT_PROP_Pos			11
#define CANFD_DBT_PROP_Msk			(0x0F << CANFD_DBT_PROP_Pos)
#define CANFD_DBT_SEG1_Pos			21
#define CANFD_DBT_SEG1_Msk			(0x07 << CANFD_DBT_SEG1_Pos)
#define CANFD_DBT_SEG2_Pos			29
#define CANFD_DBT_SEG2_Msk			(0x07u<< CANFD_DBT_SEG2_Pos)

#define CANFD_ERRCNT_RX_Pos			0
#define CANFD_ERRCNT_RX_Msk			(0xFFFF<< CANFD_ERRCNT_RX_Pos)
#define CANFD_ERRCNT_TX_Pos			16
#define CANFD_ERRCNT_TX_Msk			(0xFFFF<< CANFD_ERRCNT_TX_Pos)

#define CANFD_ERRSR_RXOV_Pos		2
#define CANFD_ERRSR_RXOV_Msk		(0x01 << CANFD_ERRSR_RXOV_Pos)
#define CANFD_ERRSR_ACK_Pos			3
#define CANFD_ERRSR_ACK_Msk			(0x01 << CANFD_ERRSR_ACK_Pos)
#define CANFD_ERRSR_FORM_Pos		4
#define CANFD_ERRSR_FORM_Msk		(0x01 << CANFD_ERRSR_FORM_Pos)
#define CANFD_ERRSR_CRC_Pos			5
#define CANFD_ERRSR_CRC_Msk			(0x01 << CANFD_ERRSR_CRC_Pos)
#define CANFD_ERRSR_STUFF_Pos		6
#define CANFD_ERRSR_STUFF_Msk		(0x01 << CANFD_ERRSR_STUFF_Pos)
#define CANFD_ERRSR_BIT_Pos			7
#define CANFD_ERRSR_BIT_Msk			(0x01 << CANFD_ERRSR_BIT_Pos)
#define CANFD_ERRSR_RXBF1_Pos		11		//RX buffer 1 receive error
#define CANFD_ERRSR_RXBF1_Msk		(0x01 << CANFD_ERRSR_RXBF1_Pos)
#define CANFD_ERRSR_RXBF0_Pos		12
#define CANFD_ERRSR_RXBF0_Msk		(0x01 << CANFD_ERRSR_RXBF0_Pos)
#define CANFD_ERRSR_TXBF2_Pos		13		//TX buffer 2 transmit error
#define CANFD_ERRSR_TXBF2_Msk		(0x01 << CANFD_ERRSR_TXBF2_Pos)
#define CANFD_ERRSR_TXBF1_Pos		14
#define CANFD_ERRSR_TXBF1_Msk		(0x01 << CANFD_ERRSR_TXBF1_Pos)
#define CANFD_ERRSR_TXBF0_Pos		15
#define CANFD_ERRSR_TXBF0_Msk		(0x01 << CANFD_ERRSR_TXBF0_Pos)

#define CANFD_RXTS_RXBF0_Pos		0		//RX Buffer 0 time stamp
#define CANFD_RXTS_RXBF0_Msk		(0xFFFF<< CANFD_RXTS_RXBF0_Pos)
#define CANFD_RXTS_RXBF1_Pos		16
#define CANFD_RXTS_RXBF1_Msk		(0xFFFF<< CANFD_RXTS_RXBF1_Pos)

#define CANFD_IF_RBF1OK_Pos			0		//RX buffer 1 received a frame successfully
#define CANFD_IF_RBF1OK_Msk			(0x01 << CANFD_IF_RBF1OK_Pos)
#define CANFD_IF_RBF0OK_Pos			1
#define CANFD_IF_RBF0OK_Msk			(0x01 << CANFD_IF_RBF0OK_Pos)
#define CANFD_IF_TBF2OK_Pos			2		//TX buffer 2 transmitted a frame successfully
#define CANFD_IF_TBF2OK_Msk			(0x01 << CANFD_IF_TBF2OK_Pos)
#define CANFD_IF_TBF1OK_Pos			3
#define CANFD_IF_TBF1OK_Msk			(0x01 << CANFD_IF_TBF1OK_Pos)
#define CANFD_IF_TBF0OK_Pos			4
#define CANFD_IF_TBF0OK_Msk			(0x01 << CANFD_IF_TBF0OK_Pos)
#define CANFD_IF_ERROR_Pos			5
#define CANFD_IF_ERROR_Msk			(0x01 << CANFD_IF_ERROR_Pos)
#define CANFD_IF_RXOV_Pos			6
#define CANFD_IF_RXOV_Msk			(0x01 << CANFD_IF_RXOV_Pos)
#define CANFD_IF_WKUP_Pos			7
#define CANFD_IF_WKUP_Msk			(0x01 << CANFD_IF_WKUP_Pos)
...
#define DCMI_SR_HSYNC_Pos			6		//0 active line   1 synchronization between lines
#define DCMI_SR_HSYNC_Msk			(0x01 << DCMI_SR_HSYNC_Pos)
#define DCMI_SR_VSYNC_Pos			7		//0 active frame   1 synchronization between frames
#define DCMI_SR_VSYNC_Msk			(0x01 << DCMI_SR_VSYNC_Pos)
#define DCMI_SR_FIFONE_Pos			8		//FIFO not empty
...
#define LCD_CRH0_HSW_Pos			0		//Hsync Width, 输出HSYNC低电平持续多少个DOTCLK周期，0表示1个周期
#define LCD_CRH0_HSW_Msk			(0x1FF<< LCD_CRH0_HSW_Pos)
#define LCD_CRH0_HBP_Pos			10		//0表示1个DOTCLK周期
#define LCD_CRH0_HBP_Msk			(0x1FF<< LCD_CRH0_HBP_Pos)
#define LCD_CRH0_HFP_Pos			20		//0表示1个DOTCLK周期
#define LCD_CRH0_HFP_Msk			(0x1FF<< LCD_CRH0_HFP_Pos)

#define LCD_CRH1_PIX_Pos			0		//水平方向的像素个数，0表示1个，最大为8191
#define LCD_CRH1_PIX_Msk			(0x1FFF<< LCD_CRH1_PIX_Pos)

#define LCD_CRV0_VSW_Pos			0		//Vsync Width，输出VSYNC低电平持续多少个行周期，0表示1个周期
#define LCD_CRV0_VSW_Msk			(0x1FF<< LCD_CRV0_VSW_Pos)
#define LCD_CRV0_VBP_Pos			10		//0表示1个水平行周期
#define LCD_CRV0_VBP_Msk			(0x1FF<< LCD_CRV0_VBP_Pos)
#define LCD_CRV0_VFP_Pos			20		//0表示1个水平行周期
#define LCD_CRV0_VFP_Msk			(0x1FF<< LCD_CRV0_VFP_Pos)

#define LCD_CRV1_PIX_Pos			0		//垂直方向的像素个数，0表示1个，最大为8191
...
typedef struct {
	...
	__IO uint32_t AAR;						//Alpha Address，Foreground Layer 的 Alpha 值存储地址
} DMA2D_TypeDef;
...
#define DMA2D_CR_AAREN_Pos			10		//1 前景层的 Alpha 值存储在 AAR 指定的地址处
#define DMA2D_CR_AAREN_Msk			(0x01 << DMA2D_CR_AAREN_Pos)
#define DMA2D_CR_BLKSZ_Pos			14		//Block Size，DMA2D 每搬运 BLKSZ 个字，可以插入 WAIT 个等待时钟周期，0 16   1 32   2 64   3 128
#define DMA2D_CR_BLKSZ_Msk			(0x03 << DMA2D_CR_BLKSZ_Pos)
#define DMA2D_CR_WAIT_Pos			16		//每传输一块数据，等待指定个系统周期后再传输下一个块，防止DMA2D占用过多SDRAM带宽，影响LCD读取显示数据
...
#define DMA2D_PFCCR_AINV_Pos		3		//Alpha Invert（按位取反）
...
#define SRA_IE_FRAME_Pos			4
#define SRA_IE_FRAME_Msk			(0x01 << SRA_IE_FRAME_Pos)
#define SRA_IE_8LINE_Pos			5
#define SRA_IE_8LINE_Msk			(0x01 << SRA_IE_8LINE_Pos)
#define SRA_IE_ROTERR_Pos			6
#define SRA_IE_ROTERR_Msk			(0x01 << SRA_IE_ROTERR_Pos)
#define SRA_IE_BUSERR_Pos			7
#define SRA_IE_BUSERR_Msk			(0x01 << SRA_IE_BUSERR_Pos)
...
#define SRA_CFG_PIXFMT_Pos			0		//Pixel Format, 0 Monochrome 8-bit   1 RGB565   2 RGB888   3 RGB888X
#define SRA_CFG_PIXFMT_Msk			(0x03 << SRA_CFG_PIXFMT_Pos)
#define SRA_CFG_ROTTYP_Pos			2		//Rotation Type, 0 normal rotation   1 x-mirror   2 y-mirror   3 x-mirror + y-mirror
#define SRA_CFG_ROTTYP_Msk			(0x03 << SRA_CFG_ROTTYP_Pos)
#define SRA_CFG_RBSWAP_Pos			4		//R/B swap, 0 RGB   1 BGR
#define SRA_CFG_RBSWAP_Msk			(0x01 << SRA_CFG_RBSWAP_Pos)
#define SRA_CFG_SXSWAP_Pos			5		//SRC X swap, 0 XRGB   1 RGBX
#define SRA_CFG_SXSWAP_Msk			(0x01 << SRA_CFG_SXSWAP_Pos)
#define SRA_CFG_DXSWAP_Pos			6		//DST X swap, 0 XRGB   1 RGBX
#define SRA_CFG_DXSWAP_Msk			(0x01 << SRA_CFG_DXSWAP_Pos)
#define SRA_CFG_ROTAAEN_Pos			7		//Rotation Anti-aliasing enable
#define SRA_CFG_ROTAAEN_Msk			(0x01 << SRA_CFG_ROTAAEN_Pos)
#define SRA_CFG_DUMMYBP_Pos			8		//Dummy tile bypass, 0 write back   1 bypass
#define SRA_CFG_DUMMYBP_Msk			(0x01 << SRA_CFG_DUMMYBP_Pos)
...
typedef struct {
    ...
    __IO uint32_t RDDELAY;
} SDRAMC_TypeDef;


#define SDRAMC_CR_COLBIT_Pos		0		//列地址位数，0 8-bit   1 9-bit   2 10-bit   3 11-bit
#define SDRAMC_CR_COLBIT_Msk		(0x07 << SDRAMC_CR_COLBIT_Pos)
#define SDRAMC_CR_BANKCNT_Pos		4		//Bank Count，0 1-bank   1 2-bank   2 4-bank
#define SDRAMC_CR_BANKCNT_Msk		(0x07 << SDRAMC_CR_BANKCNT_Pos)
#define SDRAMC_CR_CASDELAY_Pos		9		//CAS Latency，写入该字段将导致SDRAM控制器启动初始化序列，2 cl=2    3 cl=3
#define SDRAMC_CR_CASDELAY_Msk		(0x07 << SDRAMC_CR_CASDELAY_Pos)
#define SDRAMC_CR_PDEXIT_Pos		29
#define SDRAMC_CR_PDEXIT_Msk		(0x01 << SDRAMC_CR_PDEXIT_Pos)
#define SDRAMC_CR_PD_Pos			30
#define SDRAMC_CR_PD_Msk			(0x01 << SDRAMC_CR_PD_Pos)
#define SDRAMC_CR_SR_Pos			31		//Self Refresh
#define SDRAMC_CR_SR_Msk			(0x01u<< SDRAMC_CR_SR_Pos)

#define SDRAMC_TIM_TRRD_Pos			4		//Active to Active (diff bank) Command Period，0 表示 1 个 SDRAM 时钟周期
#define SDRAMC_TIM_TRRD_Msk			(0x07 << SDRAMC_TIM_TRRD_Pos)
#define SDRAMC_TIM_TRC_Pos			8		//Active to Active (same bank) Command Period
#define SDRAMC_TIM_TRC_Msk			(0x0F << SDRAMC_TIM_TRC_Pos)
#define SDRAMC_TIM_TRAS_Pos			12		//Active to Precharge Command Period
#define SDRAMC_TIM_TRAS_Msk			(0x0F << SDRAMC_TIM_TRAS_Pos)
#define SDRAMC_TIM_TWR_Pos			16		//Write to Precharge Command Period
#define SDRAMC_TIM_TWR_Msk			(0x07 << SDRAMC_TIM_TWR_Pos)
#define SDRAMC_TIM_TRCD_Pos		    20		//Row to column delay, Ie. Activate to Command delay
#define SDRAMC_TIM_TRCD_Msk		    (0x07 << SDRAMC_TIM_TRCD_Pos)
#define SDRAMC_TIM_TRP_Pos		    24		//Row precharge time,  Ie. Precharge to Activate delay
#define SDRAMC_TIM_TRP_Msk		    (0x07 << SDRAMC_TIM_TRP_Pos)
#define SDRAMC_TIM_TRFC_Pos		    27		//Refresh/load-mode to Refresh/Active Cycle
#define SDRAMC_TIM_TRFC_Msk		    (0x1Fu<< SDRAMC_TIM_TRFC_Pos)

#define SDRAMC_TIM2_TXSR_Pos		0		//Exit self refresh to ACTIVE command delay
#define SDRAMC_TIM2_TXSR_Msk		(0x1F << SDRAMC_TIM2_TXSR_Pos)
...
#define SFC_TIM_CSHIGH_Pos			22		//CS拉高最短时间：0 1个SCLK时钟周期   1 2个   2 3个   3 4个
...
#define SFC_GO_START_Pos			0		//除Flash memory读、写以外的外置Flash命令启动
#define SFC_GO_START_Msk			(0x01 << SFC_GO_START_Pos)
...
#define CACHEC_CR_RST_Pos			0		//复位Cache，只能在IDLE时置位
#define CACHEC_CR_RST_Msk			(0x01 << CACHEC_CR_RST_Pos)
#define CACHEC_CR_ALG_Pos			1		//0 LRU替换   1 随机替换
#define CACHEC_CR_ALG_Msk			(0x01 << CACHEC_CR_ALG_Pos)
#define CACHEC_CR_IDLE_Pos			2
#define CACHEC_CR_IDLE_Msk			(0x01 << CACHEC_CR_IDLE_Pos)

#define CACHEC_PREFCR_UNLOCK_Pos	0		//预取的地址由此操作释放
#define CACHEC_PREFCR_UNLOCK_Msk	(0x01 << CACHEC_PREFCR_UNLOCK_Pos)
#define CACHEC_PREFCR_PREFET_Pos	1		//预取并锁定指定地址的内容
#define CACHEC_PREFCR_PREFET_Msk	(0x01 << CACHEC_PREFCR_PREFET_Pos)
#define CACHEC_PREFCR_ADDR_Pos		2
#define CACHEC_PREFCR_ADDR_Msk		(0xFFFFFF << CACHEC_PREFCR_ADDR_Pos)
#define CACHEC_PREFCR_RDY_Pos		31		//只有在此位为1时才能执行PREFET、UNLOCK操作
#define CACHEC_PREFCR_RDY_Msk		(0x01u<< CACHEC_PREFCR_RDY_Pos)

#define CACHEC_IE_EN_Pos			0		//模块总中断使能
#define CACHEC_IE_EN_Msk			(0x01 << CACHEC_IE_EN_Pos)
#define CACHEC_IE_PREFET_Pos		1		//PREFET中断使能，只有中断使能时相应中断状态才能置起
#define CACHEC_IE_PREFET_Msk		(0x01 << CACHEC_IE_PREFET_Pos)
#define CACHEC_IE_UNLOCK_Pos		2		//UNLOCK中断使能
#define CACHEC_IE_UNLOCK_Msk		(0x01 << CACHEC_IE_UNLOCK_Pos)
#define CACHEC_IE_LOCKLMT_Pos		3		//LOCK数量达到LOCKLMT的限制中断使能
#define CACHEC_IE_LOCKLMT_Msk		(0x01 << CACHEC_IE_LOCKLMT_Pos)

#define CACHEC_IF_PREOK_Pos			0		//Prefetch OK，写1清零
#define CACHEC_IF_PREOK_Msk			(0x01 << CACHEC_IF_PREOK_Pos)
#define CACHEC_IF_PREFAIL_Pos		1		//Prefetch Fail
#define CACHEC_IF_PREFAIL_Msk		(0x01 << CACHEC_IF_PREFAIL_Pos)
#define CACHEC_IF_UNLOK_Pos			2		//Unlock OK
#define CACHEC_IF_UNLOK_Msk			(0x01 << CACHEC_IF_UNLOK_Pos)
#define CACHEC_IF_UNLFAIL_Pos		3		//Unlock Fail
#define CACHEC_IF_UNLFAIL_Msk		(0x01 << CACHEC_IF_UNLFAIL_Pos)
#define CACHEC_IF_LOCKLMT_Pos		4		//LOCK数量达到LOCKLMT
#define CACHEC_IF_LOCKLMT_Msk		(0x01 << CACHEC_IF_LOCKLMT_Pos)
...
#define CACHEC_BASE			(AHB_BASE + 0x01000)
...
#define DCMI_BASE			(AHB_BASE + 0x0D000)

#define SRA_BASE			(AHB_BASE + 0x0E000)
...
#define PORTF_BASE			(APB2_BASE + 0x00050)
...
#define GPIOF_BASE			(APB2_BASE + 0x01800)

#define UART4_BASE			(APB2_BASE + 0x03000)
#define UART5_BASE			(APB2_BASE + 0x03800)

#define SPI2_BASE			(APB2_BASE + 0x05000)
...
#define CAN0 				((CANFD_TypeDef*) CAN0_BASE)
...
#define CACHEC				((CACHEC_TypeDef*)CACHEC_BASE)

#define JPEG				((JPEG_TypeDef *) JPEG_BASE)



#include "SWM342_port.h"
#include "SWM342_gpio.h"
#include "SWM342_exti.h"
#include "SWM342_timr.h"
#include "SWM342_uart.h"
#include "SWM342_spi.h"
#include "SWM342_i2c.h"
#include "SWM342_adc.h"
#include "SWM342_pwm.h"
#include "SWM342_dma.h"
#include "SWM342_can.h"
#include "SWM342_canfd.h"
#include "SWM342_sdio.h"
#include "SWM342_sdram.h"
#include "SWM342_flash.h"
#include "SWM342_lcd.h"
#include "SWM342_sfc.h"
#include "SWM342_dac.h"
#include "SWM342_cordic.h"
#include "SWM342_crc.h"
#include "SWM342_div.h"
#include "SWM342_rtc.h"
#include "SWM342_wdt.h"
#include "SWM342_qei.h"
#include "SWM342_usb.h"
#include "SWM342_usbd.h"
#include "SWM342_usbh.h"
#include "SWM342_jpeg.h"
#include "SWM342_dcmi.h"
#include "SWM342_dma2d.h"
#include "SWM342_sra.h"
#include "SWM342_cache.h"
#include "SWM342_iofilt.h"
