#ifndef __SWM342_DMA_H__
#define __SWM342_DMA_H__
...
typedef struct {
	...
	uint32_t  INTEn;		//中断使能，有效值有 DMA_IT_DONE、DMA_IT_DST_PART、DMA_IT_SRC_PART 及其“或”
} DMA_InitStructure;
...
#define DMA_CH0_ADC0SEQ0	(2 | DMA_HS_SRC | DMA_DIR_RX)
#define DMA_CH0_ADC1SEQ0	(3 | DMA_HS_SRC | DMA_DIR_RX)

#define DMA_CH1_UART0RX		(0 | DMA_HS_SRC | DMA_DIR_RX)
#define DMA_CH1_SPI2RX		(1 | DMA_HS_SRC | DMA_DIR_RX)
#define DMA_CH1_ADC0SEQ1	(2 | DMA_HS_SRC | DMA_DIR_RX)
#define DMA_CH1_ADC1SEQ1	(3 | DMA_HS_SRC | DMA_DIR_RX)

#define DMA_CH2_UART3RX		(0 | DMA_HS_SRC | DMA_DIR_RX)
#define DMA_CH2_SPI0RX		(1 | DMA_HS_SRC | DMA_DIR_RX)
#define DMA_CH2_ADC0SEQ2	(2 | DMA_HS_SRC | DMA_DIR_RX)
#define DMA_CH2_ADC1SEQ2	(3 | DMA_HS_SRC | DMA_DIR_RX)

#define DMA_CH3_UART2RX		(0 | DMA_HS_SRC | DMA_DIR_RX)
#define DMA_CH3_SPI2RX		(1 | DMA_HS_SRC | DMA_DIR_RX)
#define DMA_CH3_ADC0SEQ3	(2 | DMA_HS_SRC | DMA_DIR_RX)
#define DMA_CH3_ADC1SEQ3	(3 | DMA_HS_SRC | DMA_DIR_RX)

#define DMA_CH4_UART5RX		(0 | DMA_HS_SRC | DMA_DIR_RX)
#define DMA_CH4_SPI1RX		(1 | DMA_HS_SRC | DMA_DIR_RX)
#define DMA_CH4_DCMI		(2 | DMA_HS_SRC | DMA_DIR_RX)

#define DMA_CH5_UART4RX		(0 | DMA_HS_SRC | DMA_DIR_RX)
#define DMA_CH5_SPI0RX		(1 | DMA_HS_SRC | DMA_DIR_RX)
#define DMA_CH5_DCMI		(2 | DMA_HS_SRC | DMA_DIR_RX)

// 目标侧外设
#define DMA_CH0_UART0TX		(0 | DMA_HS_DST | DMA_DIR_RX)
#define DMA_CH0_UART5TX		(1 | DMA_HS_DST | DMA_DIR_RX)
#define DMA_CH0_SPI0TX		(2 | DMA_HS_DST | DMA_DIR_RX)

#define DMA_CH1_UART1TX		(0 | DMA_HS_DST | DMA_DIR_RX)
#define DMA_CH1_UART4TX		(1 | DMA_HS_DST | DMA_DIR_RX)
#define DMA_CH1_SPI1TX		(2 | DMA_HS_DST | DMA_DIR_RX)

#define DMA_CH2_UART2TX		(0 | DMA_HS_DST | DMA_DIR_RX)
#define DMA_CH2_UART3TX		(1 | DMA_HS_DST | DMA_DIR_RX)
#define DMA_CH2_SPI2TX		(2 | DMA_HS_DST | DMA_DIR_RX)

#define DMA_CH3_UART3TX		(0 | DMA_HS_DST | DMA_DIR_RX)
#define DMA_CH3_UART2TX		(1 | DMA_HS_DST | DMA_DIR_RX)
#define DMA_CH3_SPI1TX		(2 | DMA_HS_DST | DMA_DIR_RX)

#define DMA_CH4_UART4TX		(0 | DMA_HS_DST | DMA_DIR_RX)
#define DMA_CH4_UART1TX		(1 | DMA_HS_DST | DMA_DIR_RX)
#define DMA_CH4_SPI0TX		(2 | DMA_HS_DST | DMA_DIR_RX)

#define DMA_CH5_UART5TX		(0 | DMA_HS_DST | DMA_DIR_RX)
#define DMA_CH5_UART0TX		(1 | DMA_HS_DST | DMA_DIR_RX)
#define DMA_CH5_SPI2TX		(2 | DMA_HS_DST | DMA_DIR_RX)
...
#define DMA_IT_DST_PART		(1 << 10)	//Destination Transfer Part，当 DMA 搬运 DMA->CH[chn].PARTLEN 个数据后，可产生 PART 中断；默认将 PARTLEN 设置为要搬运数据的一半，即搬运一半时产生中断
#define DMA_IT_SRC_PART		(1 << 18)	//Source      Transfer Part
...
void DMA_CH_Abort(uint32_t chn);
