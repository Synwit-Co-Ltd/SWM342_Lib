#ifndef __SWM342_SPI_H__
#define __SWM342_SPI_H__
...
void SPI_BIDI_In(SPI_TypeDef * SPIx);					//单线双向输入模式
void SPI_BIDI_Out(SPI_TypeDef * SPIx);					//单线双向输出模式
void SPI_BIDI_Off(SPI_TypeDef * SPIx);					//单线双向模式关闭
