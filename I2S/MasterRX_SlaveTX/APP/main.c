...
//	PORT_Init(PORTB, PIN4, PORTB_PIN4_SPI1_MOSI, 1);	// I2S_DI
	...
	DMA_initStruct.Handshake = DMA_CH3_SPI1TX;
	DMA_initStruct.Priority = DMA_PRI_LOW;
	DMA_initStruct.INTEn = DMA_IT_DST_PART | DMA_IT_DONE;
...
{
	/* Master RX */
	if(DMA_CH_INTStat(DMA_CH1, DMA_IT_DST_PART))
	{
		DMA_CH_INTClr(DMA_CH1, DMA_IT_DST_PART);
	...
	/* Slave TX */
	if(DMA_CH_INTStat(DMA_CH3, DMA_IT_DST_PART))
	{
		DMA_CH_INTClr(DMA_CH3, DMA_IT_DST_PART);
